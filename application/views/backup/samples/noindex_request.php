...
<h3  style="text-align: justify; font-size: 14px">To receive a sample copy of this report, please complete the form below</h3>
<br/>
                  <div>
...
<div class="small-9 columns">
            ...
            <div class="small-9 columns">
                    <input class="button" type="submit" value="Submit Request"></div>
