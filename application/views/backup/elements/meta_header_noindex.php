...
<ul id="css3menu1" class="topmenu" style="padding-top:12px;">
    ...
    <form action="<?php echo base_url('filters'); ?>" method="get">
                        ...
                        <div class="input-group mobile-input" > 
                               ...
                               <input type="text" id="search_data" class="search-input search" name="q" value="<?php echo $this->input->get('q') ?>" placeholder="Search Report" onkeyup="liveSearch()" autocomplete="off" style="border-radius:5px; padding: 0; padding-left: 8px; height: 1.93em;">
