...
<h3  style="text-align: justify; font-size: 15px">To receive a sample copy of this report, please complete the form below</h3>
<br/>
                  <div>
                     <?php $attributes = array('class'=> 'jsform');
                echo form_open("smail/inquirybuy", $attributes); ?>
...
<div class="small-9 columns">
                    <input class="" type="email" name="email" placeholder="Please Enter Your Company Email Address"  required>
</div>
...
<div class="small-3 columns">
		...
		<div class="small-9 columns">
                    <input class=""  type="number" name="phone" required>
                </div>
				...
				<div class="medium-9 columns">
					<select class="form-in" name="country_user"  type="number" name="phone" required="required">
