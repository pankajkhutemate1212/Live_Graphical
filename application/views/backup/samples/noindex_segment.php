...
<li><a href="<?php echo base_url('');?>">Home</a></li>
  ...
  <?php echo  substr($reports['name'],0,100);  ?>...
    ...
    <li class="active"><a href="<?php echo base_url('request-sample/upcoming-detail/'.$reports['id']);?>">Industry Coverage</a></li>
...
<div class="mobileuibtn" style="text-align: center">
    ...
    <a  class="button "> <span>Industry Coverage</span></a>
...
<p> <?php echo $reports['free_analysis']; ?></p>
