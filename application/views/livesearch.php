...
<meta name='yandex-verification' content='584e18acce1511c7' />
...
<!-- Hotjar Tracking Code for https://www.gminsights.com -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:318961,hjsv:5};
...
_atrk_opts = { atrk_acct:"jtsYm1a4KM+27i", domain:"gminsights.com",dynamic: true};
(function() { var as = document.createElement('script'); as.type = 'text/javascript'; as.async = true; as.src = "https://d31qbv1cthcecs.cloudfront.net/atrk.js"; var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(as, s); })();
</script>
<noscript><img src="https://d5nxst8fruw4z.cloudfront.net/atrk.gif?account=jtsYm1a4KM+27i" style="display:none" height="1" width="1" alt="" /></noscript>
...
<div class="top-bar small-14" style="background: #ececec">
            ...
            <div class="row">
                ...
                <div class="top-bar-right mobileui" style="">

                    <div class="h-contact" style="float:right;">
                       <ul class="dropdown menu" style="" data-dropdown-menu="2z1axb-dropdown-menu" role="menubar">
                        <li role="menuitem" class="h-separator"><a href="javascript:void();" style="cursor:default;"><b style="color: #808080"> <i class="fi-telephone" style="color: #808080; font-sizze:18px;"></i>&nbsp;1-302-846-7766</b></a></li>
                         <li role="menuitem" ><a href="javascript:void();" style="cursor:default; padding-left:0px;"><b style="color: #808080" >| &nbsp;&nbsp;1-888-689-0688</b></a></li>
                       </ul>  
                       </div>
                       
                  <div class="h-menu" style="float:right;">
                    <ul class="dropdown menu" style="" data-dropdown-menu="2z1axb-dropdown-menu" role="menubar">
...
<ul id="css3menu1" class="topmenu" style="padding-top:12px;">
    ...
    <form action="<?php echo base_url('filters'); ?>" method="get">
                        ...
                        <div class="input-group mobile-input" > 
                               ...
                               <input type="text" id="search_data" class="form-control search-input search" name="q" placeholder="Search Report" onkeyup="liveSearch()" autocomplete="off" style="border-radius:1000px; padding: 0; padding-left: 8px; height: 1.93em;">
                  <div id="suggestions">
