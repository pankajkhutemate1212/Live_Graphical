...
<tr>
<td>
<label><input name="status" value="Y" type="radio" checked=""><span class="lbl"> Active</span></label>
...
<td> 
<select class="chzn-select" name="cat" id="cat" data-placeholder="Choose a Category">
<option value="" />
<option value="82" />Advanced Materials
<option value="73" />Automotive
<option value="74" />Chemicals
<option value="75" />Construction & Utilities
<option value="76" />Electronics & Semiconductors
<option value="77" />Energy & Mining
<option value="78" />Food & Feed
<option value="80" />Medical Devices & Pharma
<option value="79" />Next generation Technologies
<option value="81" />Renewable & Green Chemistry
</select> 
...
<td> 
<select class="chzn-select" name="body" id="body" data-placeholder="Choose a Category">
<option value="" />
<option value="body1" selected="" />Published
<option value="body2" />Upcoming
...
<td><input type="text" name="brief_desc" style="width: 400%;" placeholder="150 charatcters"> </td>
 ...
 <td><input type="text" name="s_price" value="2500" placeholder="US $"> </td>



 <td>Multi-user Price</td>

 <td><input type="text" name="m_price" value="4500" placeholder="US $"> </td>

 <td>Enterprise Price</td>

<td><input type="text" name="e_price" value="6500" placeholder="US $" > </td>
...
<input name="yearrb" id="yearrb" type="radio" value="2025" required=""><span class="lbl"> 2025</span>
</td>
</tr>
...
<p> <textarea name="seg_editor" class="ckeditor"></textarea>
