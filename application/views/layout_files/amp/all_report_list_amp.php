    ...
    <div class="small-12 medium-12 columns about-people">
      <div class="about-people-author">
        <p class="report-title-name">
			<a href="<?php echo base_url('/industry-insights/'.$row->id.'/'.$row->url.'/amp'); ?>">
<?php echo str_replace("&","&amp;",$row->name); ?></a></p>
           <p class="author-location">
          <i class="fa fa-map-marker" aria-hidden="true"></i>
          Delivery: PDF <amp-img src="<?php echo base_url('assets/images/market-research-pdf.png'); ?>" height="14" width="14" ></amp-img>
        </p>
       </div>    
    </div>
</div>
