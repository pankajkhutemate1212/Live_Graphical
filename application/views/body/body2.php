...
<div  class="mobileuibtn" style="text-align: center; padding: 0 2px;">
    ...
    <a href="<?php echo base_url('methodology/upcoming-detail/'.$reports['url'].'') ?>" class="button secondary"> <span>Methodology</span></a>
...
<div class="infodiv2">What was the historic market data from 2012 to 2015, what is the industry growth forecast from 2016 to 2024?</div>
...
<div class="infodiv2" style="padding-bottom:8px">Which companies lead the industry, how are they positioned in the market in terms of sustainability, competency, production capacity and strategic outlook?</div></div>
...
<div class="callout mobileuifont " style="font-size: 0.9rem">
   ...
   <p style="font-weight:bold;color:#0F3971;font-size:1.1em;font-weight:bold;"> Why Global Market Insights?</p>
    ...
    <ul class="square">
       ...
       <li>Unique methodology  <div class="" style="display:inline;"><a class="button frost btncustominq" href="<?php echo base_url('/inquiry-before-buying/'.$reports['id']); ?>" style="visibility:hidden; width: 45%; font-size: 9px; padding-top: 6px; padding-bottom: 0px;margin-bottom: 1px;background-color: #d7ab00 !important;">Inquiry Before Buying</a></div> </li>
