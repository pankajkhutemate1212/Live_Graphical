...
<li><a href="<?php echo base_url('');?>">Home</a></li>
  ...
  <li><a href="<?php echo base_url('/industry-analysis'); ?>/<?php echo $reports['url']; ?>"><?php echo $reports['meta_title']; ?></a></li>
    <li class="active"><a href="<?php echo base_url('request-sample/upcoming-detail/'.$reports['id']);?>">Table of Contents</a></li>
...
<h3  style="text-align: justify; font-size: 14px;">To request a copy of the table of contents for this report, please complete the form below</h3>
                ...
                <input type="hidden" autocomplete="off"  name="requestId" id="requestId" value="<?php echo $reports['id']; ?>" />
                <input type="hidden" autocomplete="off" name="url" id="url" value="<?php echo base_url('/request/'.$reports['id']); ?>" required />
...
<div class="small-3 columns">
		...
		<div class="small-9 columns">
                ...
                <input class="" autocomplete="off"  type="hidden" name="ip" value="<?php echo $ip = $_SERVER['REMOTE_ADDR'];   ?>" >
                <input  class="" autocomplete="off" type="hidden" name="ridd" value="<?php echo $reports['id']; ?>"/>
                <input  class="" autocomplete="off" type="hidden" name="rcatt" value="<?php echo $category['name']; ?>"/>
...
<div class="small-9 columns">
            ...
            <div class="small-9 columns">
                    <input class="button small" type="submit" value="Submit Request" ></div>
                    <div class="small-12 columns">
               <p style="font-size:12px;">Your personal information is kept secure & confidential.<br />
               
               <a target="_blank" href="<?php echo base_url('privacy-policy'); ?>"> Privacy Policy</a></p>
                </form>
