...
<div class="row" id="content">
                    <div class="card" style="padding-top: 21px;padding-left: 21px;">
                        <div class="medium-3 columns mobileui" data-sticky-container>
...
.medium-9
{
	width:100%;
                        ...
                        <div class="medium-9 columns mobileuifont">
                            <h2 style="font-size:1.5625rem;"> Reports & Publications</h2>  
                            <hr>  
                                <div class="blog-post">
...
<?php echo str_replace("&","&amp;",$row->name); ?></p></a></b>
          ...
          <?php if(!empty($reportsup)){
             foreach($reportsup as $row){ ?>
