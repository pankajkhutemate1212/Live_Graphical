 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'pagefic1945-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'T37SVRPB5YR7Q9Y9' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-AVkhu8-RhwZywrYrUEz8StgAFWft' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? 'pagefic1945-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['PayFlowPassword'] = $config['Sandbox'] ? 'T37SVRPB5YR7Q9Y9' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['PayFlowVendor'] = $config['Sandbox'] ? 'SANDBOX_VENDOR_GOES_HERE' : 'PRODUCTION_VENDOR_GOES_HERE';
$config['PayFlowPartner'] = $config['Sandbox'] ? 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-AVkhu8-RhwZywrYrUEz8StgAFWft' : 'PRODUCTION_PARTNER_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'vikasmantute@gmail.com';
